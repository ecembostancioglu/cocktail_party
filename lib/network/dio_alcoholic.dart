...
class DioAlcoholic extends DioClient{

  Future<Iterable<Cocktail>> getAlcoholic()async{
    Iterable<Cocktail> alcohols=[];
 try{
     final Response response=await dio.get('${baseUrl}api/json/v1/1/filter.php?a=Alcoholic');
